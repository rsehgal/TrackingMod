...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Tracking::Vector3D<double>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Tracking::Vector3D<double>", "Vector3D.h", 50,
...
"/home/rsehgal/Tomo/TrackingMod/Tree/inc/",
0
    };
...
namespace Tracking{template <class Type> class __attribute__((annotate("$clingAutoload$Vector3D.h")))  Vector3D;
}

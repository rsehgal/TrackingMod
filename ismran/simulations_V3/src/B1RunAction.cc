...
void B1RunAction::BeginOfRunAction(const G4Run *)
{
  ...
  fCalib = new lite_interface::Calibration("completeCalib2.root");
}

void B1RunAction::WriteData()
{
  std::cout << "SIZE OF MUON TRACK VECTOR going to be written in ROOT File : " << MySD::muonTrackVec.size()
            << std::endl;
...
void B1RunAction::EndOfRunAction(const G4Run *run)
{
  ...
  // std::cout << "No of Particles reaches Sensitive Detector Region : " << Tomography::EventBreak::instance()->fEffEvNo
  // << std::endl;
  std::cout << "====================================================================" << std::endl;
  ...
  // std::cout << ((1.0*MySD::numOfStoppedParticles/Tomography::EventBreak::instance()->fEffEvNo)*100)<<" % of Number of
  // particles that reaches the Sensitive detector region" << std::endl;

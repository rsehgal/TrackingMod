...
public:
  ...
  ScintillatorBar_V2(ushort barIndex, ushort qlongNear, ushort qlongMean, ULong64_t tstampSmall, Long_t delTStamp);
  ...
  ScintillatorBar_V2(ushort barIndex, ushort qlongNear, ushort qlongMean, ULong64_t tstampSmall, Long_t delTStamp,
                     double hitx, double hity, double hitz, double exactHitX, double exactHity, double exactHitZ);
  ScintillatorBar_V2(ushort barIndex, ushort qlongNear, ushort qlongMean, ULong64_t tstampSmall, Long_t delTStamp,
                     double hitx, double hity, double hitz, double exactHitX, double exactHity, double exactHitZ,
                     double logQNearByQFar);

  /*lite_interface::Point3D* GetMeanHitPosition();
  lite_interface::Point3D* GetExactHitPosition();*/
#ifdef USE_CALIBRATION
  void CalculateVariousPhysicalParameters(unsigned long muonNum, lite_interface::Calibration *calib);
  void SmearHitPosition(unsigned long muonNum, lite_interface::Calibration *calib);

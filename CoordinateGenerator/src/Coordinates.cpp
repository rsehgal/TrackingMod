...
>>>>>>> vatsal/Tracking_v1
  if(flag==0)
  {
          det = Tomography::SetupManager::instance()->GetUpperLayerDetectorVector("GLASS");  //Need to pass value of
'fDetectorType'
          N = det.size();
  }
  else
     {
          det = Tomography::SetupManager::instance()->GetLowerLayerDetectorVector("GLASS");	//Need to pass value of
'fDetectorType'
          N = det.size();
     }
//	M = M1;
